...
class Dff():
    ...
    def get_items(self, city_code):
        ...
        url = 'http://www.dff.com.tw/Function/Ajax/SearchObj.aspx'
        ...
        while page<last_page:
            ...
            try:
                ...
                for item in items:
                    link = 'http://www.dff.com.tw' + item.find('a')['href']
                    ...
                    if match:
                        ...
                        re_price = int(float(item.find('span',{'class':'discount'}).text))
                    obj_data = {
                                "source_id" : source_id,
                                "subject" : subject,
                                "link" : link,
                ...
                pages = soup.select_one('#button')
                if pages:
                    last_page = int(pages.find_all('option')[-1].text)
    ...
    def get_data(self, city_code):
        ...
        for obj in list_obj:
            try:
                ...
                if img:
                    img_url = img.get_attribute_list('content')[0]
                else:
                    img_url = ''
