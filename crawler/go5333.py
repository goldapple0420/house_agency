...
class Go5333():
    ...
    def get_items(self, city_code):
        ...
        url = 'https://www.go5333.com.tw/Function/Ajax/SearchObj.aspx'
        ...
        while page<last_page:
            ...
            try:
                ...
                for i in items:
                    ...
                    link = 'https://www.go5333.com.tw'+item.get_attribute_list('href')[0]
                    subject = item.text
                    ...
                    if match:
                        ...
                        re_price = int(i.find('span',{'class':'discount'}).text)
                    obj_data = {
                                "source_id" : source_id,
                                "subject" : subject,
                                "link" : link,
        ...
        for obj in list_obj:
            ...
            try:
                ...
                if match:
                    pattern = match[0]
                    if '(另加蓋' in pattern:
                        pattern, pattern1 = pattern.split(r'(另')
