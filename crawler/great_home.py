...
class GreatHome():
    ...
    def get_items(self, city_code):
        ...
        index_url = 'https://www.great-home.com.tw/ajax/dataService.aspx?job=search&path=house'
        header = {
    ...
    def get_data(self, city_code):
        ...
        for house in house_list:
            ...
            link = 'https://www.great-home.com.tw/detail/?sn=' + source_id
            print(subject, link)
            ...
            try:
                ...
                info = soup.find('div',{'class':'basicinfo-box'})
                deatail = info.find_all('tr')
                ...
                # 比較完整的特色說明
                # feature = ''
                # is_feature = soup.find('ul',{'class':'features-other'})
                # if is_feature:
                #     features = is_feature.find_all('li')
                #     for f in features:
                ...
                # 經緯度
                map_url = f'https://www.great-home.com.tw/detail/map.aspx'
                map_header = {
                ...
                # 房仲資料有兩種格式 1.住商不動產(無房仲名字) 2.大家房屋
