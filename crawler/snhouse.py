...
class SNhouse():
    ...
    def get_items(self, city_code):
        ...
        url = 'https://snhouse.com.tw/Function/Ajax/SearchObj.aspx'
        ...
        while page<last_page :
            ...
            try:
                ...
                for item in items:
                    link = 'https://snhouse.com.tw' + item.find('a')['href']
                    ...
                    if match:
                        re_price = float(match[0])
                    else:
                        re_price = float(item.find('span',{'class':'discount'}).text)
                    obj_data = {
                                "source_id" : source_id,
                                "subject" : subject,
                                "link" : link,
